...
class CreateRoomActivity : AppCompatActivity() {
    ...
    private var selectedCategory = "chat"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvCategory.setOnClickListener {
            val cats = arrayOf("Music", "Games", "Chat", "Karaoke", "Dating", "PK Battle")
            val ids = arrayOf("music", "games", "chat", "karaoke", "dating", "pk")
            AlertDialog.Builder(this)
                .setItems(cats) { _, which ->
                    selectedCategory = ids[which]
                    tvCategory.text = cats[which]
                }.show()
        }

        tvRegion.setOnClickListener {
            val regions = arrayOf("Global", "Middle East", "Asia", "Europe", "N. America")
            val ids = arrayOf("global", "me", "asia", "eu", "na")
            AlertDialog.Builder(this)
                .setItems(regions) { _, which ->
                    selectedRegion = ids[which]
                    tvRegion.text = regions[which]
                }.show()
        }
