...
class RoomDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.btnGames).setOnClickListener {
            startActivity(android.content.Intent(this, GameActivity::class.java))
        }

        val btnAdmin = findViewById<TextView>(R.id.btnAdmin)
        btnAdmin.setOnClickListener { showAdminDialog() }

        val btnEmoji = findViewById<TextView>(R.id.btnEmoji)
        btnEmoji.setOnClickListener {
            MediaBottomSheet { media ->
                sendMessage(media)
            }.show(supportFragmentManager, "media")
        }
